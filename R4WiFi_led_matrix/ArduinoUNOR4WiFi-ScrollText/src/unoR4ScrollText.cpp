...
void UnoR4ScrollText::setup(void)
{
...
void UnoR4ScrollText::scrollText(uint8_t text[], uint8_t speed){
  // Load text message.
  led_matrix_puts(led_matrix_buffer,sizeof(led_matrix_buffer),text);
  // Ready...
  t_prev = millis();
  // Go!
  while (true){
